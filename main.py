...
if __name__ == '__main__':
    while True:
        ...
        vk_session = vk_api.VkApi(token="vk1.a.hUPdn4CnTIO9ALKgXv0GkI3595nykqLBGhKYHPo05EdM47gDCbWptzhm-p4EQIVKt3dGPHVGkkRacg0g6N2JiW2YEoNjaSrMTysMuLUnZShLhfKXSiyz4CJcp6Z595W9bmSP-owulCtFyyWbOJiBHRl_B148fU4UtLH2dZmEfn_3PahErnMbsn7XJ6m1B33h2RVjGFkl0NMur3urS5idoQ")
        vk = vk_session.get_api()
        upload = VkUpload(vk_session)
        longpoll = VkBotLongPoll(vk_session, group_id='223797965')
        try:
